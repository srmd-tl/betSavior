...
<html lang="en">
  <head>
    ...
    <title>Bet Savior | @yield('title')</title>
  </head>
  <body>
    <div >
	<!-- Topbar -->
	<div class="top">
			<div class="container">
		  		<div class="row">
					<div class="btn-group">
					<!-- 	<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">All Sports </button>
            ...
            <button class="btn btn-primary rightLst">></button>
					...
					<!-- end games -->
					    ...
					    <!-- <div class="col-md d-flex topper align-items-center align-items-stretch py-md-4">
					    	<div class="icon d-flex justify-content-center align-items-center"><i style="color: #ffba00;padding-right: 20px;font-size: 1.5em;" class="fas fa-envelope"></i></div>
					    	<div class="text">
					    		<span>Email</span>
					    ...
					    <div class="col-md d-flex topper align-items-center align-items-stretch py-md-4">
					    	<div class="icon d-flex justify-content-center align-items-center"><i style="color: #ffba00;padding-right: 20px;font-size: 1.5em;margin-top:20px;" class="fas fa-phone fa-rotate-90"></i></div>
						    <div class="text">
						    	<span>Call</span>
					    ...
					    <div class="col-md d-flex topper align-items-center align-items-stretch py-md-4">
					    	<div class="icon d-flex justify-content-center align-items-center"><i style="color: #ffba00;padding-right: 20px;font-size: 1.5em;" class="fas fa-clock "></i></span></div>
						    <div class="text">
	...
	<!-- news -->
					<!-- <h1 style="margin-top:50px;">NEWS <span style="color:#004ad6; " >& UPDATES</span></h1> -->
        ...
        <div class="col-12 pb-5">
            ...
            <!--END SECTION-->
					...
					<!-- end news -->
<!--	<div class="container-fluid" style="background:#1d1d20;">
        <div class="row">
            <div class="col-md-12">
           ...
           <!--         <div class="carousel-inner">
                  ...
                  <!--  <ul class="nav nav-pills nav-justified" >
                        <li data-target="#myCarousel" data-slide-to="0" class="nav-item active"><a href="#" class="nav-link"><strong>£25</strong>Up to £25 in Free Bets</a></li>
                        <li data-target="#myCarousel" data-slide-to="1" class="nav-item"><a href="#" class="nav-link"><strong>TAB 2</strong>Up to £50 in Free Bets</a></li>
                        <li data-target="#myCarousel" data-slide-to="2" class="nav-item"><a href="#" class="nav-link"><strong>TAB 3</strong>Up to £100 in Free Bets</a></li>
                        <li data-target="#myCarousel" data-slide-to="3" class="nav-item"><a href="#" class="nav-link"><strong>TAB 4</strong>Up to £250 in Free Bets</a></li>
                    </ul>
                </div> 
            </div>
        </div>
